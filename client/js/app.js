...
class EventsManager {
    ...
    obtenerDataInicial() {
        ...
        $.ajax({
          ...
          error: function(){
            alert("error en la comunicación con el servidorOBdini");
          }
        })
    ...
    anadirEvento(){
      ...
      $.ajax({
        ...
        error: function(){
          alert("error en la comunicación con el servidorAnadirEven");
        }
      })
    ...
    eliminarEvento(event, jsEvent){
      ...
      $.ajax({
        ...
        error: function(){
          alert("error en la comunicación con el servidorEliminaEve");
        }
      })
    ...
    actualizarEvento(evento) {
        ...
        $.ajax({
          ...
          success: (data) =>{
            if (data.msg=="OK") {
              alert('Se ha actualizado el evento exitosamenteActuaEvent')
            }else {
              alert(data.msg)
            }
          },
